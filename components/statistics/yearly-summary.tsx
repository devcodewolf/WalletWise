...
export function YearlySummary({
	...
	return (
		<div className='flex md:flex-col lg:flex-row justify-around *:flex-1 *:py-3 gap-2 rounded-xl bg-background/40 border border-border px-4 mt-5 mx-5 md:mx-0 lg:mx-5'>
